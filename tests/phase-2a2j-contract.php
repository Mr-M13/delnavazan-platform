...
foreach (array('a_same_teacher_keys','c_replace_end','d1_replace_diff','d2_replace_same','e_initial_archive','e_replace_archive','e_archive_initial','e_archive_replace','f_initial_close','f_replace_close','f_close_initial','f_close_replace','u1_unrelated_roots','u2_shared_teacher','competing_initial_teacher=not_applicable_exact_source_only') as $needle) if (!str_contains($race, $needle)) throw new RuntimeException('Missing Phase J concurrency matrix scenario: ' . $needle);
