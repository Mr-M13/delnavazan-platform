...
if ((!str_contains($plugin, "DZN_PLATFORM_SCHEMA_VERSION', '16'") && !str_contains($plugin, "DZN_PLATFORM_SCHEMA_VERSION', '17'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '18'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '19'")) || (!str_contains($plugin, 'phase2a2j-teacher-assignment-foundation-20260915.1') && !str_contains($plugin, 'phase2a2k-canonical-term-foundation-20260916.1') && !str_contains($plugin, 'phase2a2l-canonical-term-authority-20260916.1') && !str_contains($plugin, 'phase2a2m-canonical-lesson-authority-20260916.1'))) throw new RuntimeException('Missing compatible Phase J+ identity');
