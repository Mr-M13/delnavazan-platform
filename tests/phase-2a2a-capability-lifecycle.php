...
$method->invoke(null);
if (!$phase2a2aAdmin->has_cap('dzn_manage_terms') || !$phase2a2aAdmin->has_cap('dzn_prepare_booking_request_matches') || !$phase2a2aAdmin->has_cap('dzn_manage_booking_request_coordination') || !$phase2a2aAdmin->has_cap('dzn_manage_teacher_availability_assent') || !$phase2a2aAdmin->has_cap('dzn_issue_booking_request_proposals') || !$phase2a2aAdmin->has_cap('dzn_record_booking_request_provisional_acceptance') || !$phase2a2aAdmin->has_cap('dzn_resolve_booking_request_student_identity') || !$phase2a2aAdmin->has_cap('dzn_manage_student_acceptance_authority') || !$phase2a2aAdmin->has_cap('dzn_view_student_acceptance_eligibility') || !$phase2a2aAdmin->has_cap('dzn_finalize_service_arrangements') || !$phase2a2aAdmin->has_cap('dzn_convert_service_arrangements_to_enrolments') || !$phase2a2aAdmin->has_cap('dzn_manage_teacher_assignments') || !$phase2a2aAdmin->has_cap('dzn_manage_canonical_terms') || get_option('dzn_platform_capability_version') !== '2a2l') throw new RuntimeException('Absent capability marker was not installed');
...
unset($phase2a2aAdmin->caps['dzn_manage_terms'], $phase2a2aAdmin->caps['dzn_prepare_booking_request_matches'], $phase2a2aAdmin->caps['dzn_issue_booking_request_proposals'], $phase2a2aAdmin->caps['dzn_record_booking_request_provisional_acceptance'], $phase2a2aAdmin->caps['dzn_resolve_booking_request_student_identity'], $phase2a2aAdmin->caps['dzn_manage_student_acceptance_authority'], $phase2a2aAdmin->caps['dzn_view_student_acceptance_eligibility'], $phase2a2aAdmin->caps['dzn_finalize_service_arrangements'], $phase2a2aAdmin->caps['dzn_convert_service_arrangements_to_enrolments'], $phase2a2aAdmin->caps['dzn_manage_teacher_assignments'], $phase2a2aAdmin->caps['dzn_manage_canonical_terms']);
$method->invoke(null);
if (!$phase2a2aAdmin->has_cap('dzn_manage_terms') || !$phase2a2aAdmin->has_cap('dzn_prepare_booking_request_matches') || !$phase2a2aAdmin->has_cap('dzn_manage_booking_request_coordination') || !$phase2a2aAdmin->has_cap('dzn_manage_teacher_availability_assent') || !$phase2a2aAdmin->has_cap('dzn_issue_booking_request_proposals') || !$phase2a2aAdmin->has_cap('dzn_record_booking_request_provisional_acceptance') || !$phase2a2aAdmin->has_cap('dzn_resolve_booking_request_student_identity') || !$phase2a2aAdmin->has_cap('dzn_manage_student_acceptance_authority') || !$phase2a2aAdmin->has_cap('dzn_view_student_acceptance_eligibility') || !$phase2a2aAdmin->has_cap('dzn_finalize_service_arrangements') || !$phase2a2aAdmin->has_cap('dzn_convert_service_arrangements_to_enrolments') || !$phase2a2aAdmin->has_cap('dzn_manage_teacher_assignments') || !$phase2a2aAdmin->has_cap('dzn_manage_canonical_terms')) throw new RuntimeException('Missing current capability was not restored');
