...
if(!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '13'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '14'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '15'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '16'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '17'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '18'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '19'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '20'"))throw new RuntimeException('Missing compatible Phase 2A.2-G+ schema marker');
if(!str_contains($plugin,'phase2a2g-final-acceptance-arrangement-20260910.1')&&!str_contains($plugin,'phase2a2h-canonical-enrolment-foundation-20260913.1')&&!str_contains($plugin,'phase2a2i-enrolment-conversion-authority-20260914.1')&&!str_contains($plugin,'phase2a2j-teacher-assignment-foundation-20260915.1')&&!str_contains($plugin,'phase2a2k-canonical-term-foundation-20260916.1')&&!str_contains($plugin,'phase2a2l-canonical-term-authority-20260916.1')&&!str_contains($plugin,'phase2a2m0-enrolment-lifecycle-authority-20260917.1')&&!str_contains($plugin,'phase2a2m-canonical-lesson-authority-20260917.1'))throw new RuntimeException('Missing compatible Phase 2A.2-G+ build marker');
foreach(array('013_final_acceptance_arrangement_foundation','accepted_service_arrangements','proposal_option_outcome_events','verify_final_acceptance_arrangement_schema','dzn_finalize_service_arrangements','ENGINE=InnoDB')as$n)if(!str_contains($migration.$plugin,$n))throw new RuntimeException('Missing Phase 2A.2-G foundation: '.$n);
