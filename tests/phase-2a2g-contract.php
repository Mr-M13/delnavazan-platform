...
if(!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '13'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '14'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '15'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '16'"))throw new RuntimeException('Missing compatible Phase 2A.2-G+ schema marker');
if(!str_contains($plugin,'phase2a2g-final-acceptance-arrangement-20260910.1')&&!str_contains($plugin,'phase2a2h-canonical-enrolment-foundation-20260913.1')&&!str_contains($plugin,'phase2a2i-enrolment-conversion-authority-20260914.1')&&!str_contains($plugin,'phase2a2j-teacher-assignment-foundation-20260915.1'))throw new RuntimeException('Missing compatible Phase 2A.2-G+ build marker');
