...
if (!str_contains($plugin, 'phase2a2k-canonical-term-foundation-20260916.1') && !str_contains($plugin, 'phase2a2l-canonical-term-authority-20260916.1') && !str_contains($plugin, 'phase2a2m-canonical-lesson-authority-20260916.1')) throw new RuntimeException('Missing compatible Phase K+ build');
