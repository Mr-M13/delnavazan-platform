...
if (!preg_match('/(?:Teacher assent|Proposal|Provisional acceptance) capability installation failed/', $migration)) throw new RuntimeException('Missing deterministic capability installation failure handling');
