<?php
/** Attribute the gated Phase-P contender's database lock wait, then let the runner release worker 1. */
if(getenv('DZN_PHASE_2A2P_RUNTIME_TEST')!=='concurrency'||!defined('WP_CLI')||!WP_CLI)exit(1);
global $wpdb;
...
$mechanism='unavailable';$evidence=null;$started=microtime(true);
