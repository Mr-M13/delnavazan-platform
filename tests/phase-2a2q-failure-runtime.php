...
foreach(array('canonical_continuation_commands','canonical_continuation_interventions','canonical_continuation_reservations','canonical_continuation_decisions','canonical_continuation_cases')as$t)dzn_qf_assert($wpdb->query("DELETE FROM {$p}{$t}")!==false,'Failed to reset disposable Phase Q storage');
