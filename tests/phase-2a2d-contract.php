...
foreach ( array( 'createStudent', 'createLesson', 'createEnrolment', 'acceptProposal', 'teacher_assignments', 'accepted_service', 'platform_payments', 'amelia_', 'wp_amelia', 'register_rest_route', 'platform_outbox' ) as $forbidden ) if ( stripos( $service . $repository . $controller, $forbidden ) !== false ) throw new RuntimeException( 'Proposal Foundation exceeded authority: ' . $forbidden );
