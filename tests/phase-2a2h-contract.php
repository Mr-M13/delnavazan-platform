...
foreach (["DZN_PLATFORM_SCHEMA_VERSION', '14'", 'phase2a2h-canonical-enrolment-foundation-20260913.1'] as $fragment) {
    if (!str_contains($plugin, $fragment)) throw new RuntimeException('Missing Phase H identity: ' . $fragment);
}
