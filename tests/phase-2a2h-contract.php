...
if(!str_contains($plugin,'phase2a2h-canonical-enrolment-foundation-20260913.1')&&!str_contains($plugin,'phase2a2i-enrolment-conversion-authority-20260914.1')&&!str_contains($plugin,'phase2a2j-teacher-assignment-foundation-20260915.1')&&!str_contains($plugin,'phase2a2k-canonical-term-foundation-20260916.1')&&!str_contains($plugin,'phase2a2l-canonical-term-authority-20260916.1'))throw new RuntimeException('Missing compatible Phase H+ build identity');
