...
if(!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '14'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '15'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '16'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '17'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '18'")&&!str_contains($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '19'"))throw new RuntimeException('Missing compatible Phase H+ schema identity');
if(!str_contains($plugin,'phase2a2h-canonical-enrolment-foundation-20260913.1')&&!str_contains($plugin,'phase2a2i-enrolment-conversion-authority-20260914.1')&&!str_contains($plugin,'phase2a2j-teacher-assignment-foundation-20260915.1')&&!str_contains($plugin,'phase2a2k-canonical-term-foundation-20260916.1')&&!str_contains($plugin,'phase2a2l-canonical-term-authority-20260916.1')&&!str_contains($plugin,'phase2a2m0-enrolment-lifecycle-authority-20260917.1'))throw new RuntimeException('Missing compatible Phase H+ build identity');
