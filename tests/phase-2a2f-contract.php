...
if(strpos($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '12'")===false&&strpos($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '13'")===false&&strpos($plugin,"DZN_PLATFORM_SCHEMA_VERSION', '14'")===false)throw new RuntimeException('Missing compatible Phase 2A.2-F schema marker');
