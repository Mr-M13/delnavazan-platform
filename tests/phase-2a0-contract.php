...
foreach ( ['bin2hex(random_bytes(32))', 'hash_hmac(', 'recovery_required', 'Authenticated principal ownership and recipient binding required', 'Invitation has been superseded', 'Teacher principal link already exists', 'teacher_principal.claim_finalized'] as $fragment ) if ( strpos( $service, $fragment ) === false ) throw new RuntimeException( 'Missing invitation/claim contract: ' . $fragment );
