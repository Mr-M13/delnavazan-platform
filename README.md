...
| Active Platform candidate | Phase 2A.2-V — Provider-Neutral Google Calendar & Meet Integration (Schema 27 / migration `027_google_calendar_meet_provider_integration` / build `phase2a2v-provider-neutral-google-calendar-meet-20260925.4`; **reconstructed** after the loss of the previously recorded candidate `3724edb3…`, with **correction round 2** applied to the review-failed candidate `6c2ab1ce…`, **correction round 3** applied to the review-failed candidate `d9eec897…` and **correction round 4** applied to the review-failed candidate `d9c47b60…` — canonical lock order and provider-scoped receipt sequence — awaiting independent review) |
