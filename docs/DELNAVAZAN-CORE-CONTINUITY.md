...
| Phase 2A.2-V reconstructed candidate | Schema 27 / migration `027_google_calendar_meet_provider_integration` / build `phase2a2v-provider-neutral-google-calendar-meet-20260925.1`, strictly additive on base `559b1736621c9ed32e41dd2b785dd0f040dcb647` (tree `4e7fb1736b4a30de323cd25fe5dd4b6ceaad65a1`). **The previously recorded Phase-V candidate `3724edb3c36959f3657e6b495ab96f26d347c476` / tree `5402cf890e2db898bccb15ba8ffc97176ced6457` was lost from every current workspace, backup object store, reflog and remote branch.** This candidate is a contract-faithful reconstruction from the completed `PLATFORM-V-GOOGLE-CONTRACT-PREFLIGHT` contract, the authoritative current code/docs and the preserved Phase-V run evidence; it is a candidate only — awaiting independent review, not merged, not deployed, with no live credential, provider traffic, production data or cutover. See `docs/PHASE-2A-2V-GOOGLE-CALENDAR-MEET-PROVIDER-NEUTRAL-INTEGRATION.md`. |
| Schema | 24 |
